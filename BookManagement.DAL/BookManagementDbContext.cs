...
public partial class BookManagementDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C20759581DEF");
        ...
        {
            entity.HasKey(e => e.BookCategoryId).HasName("PK__BookCate__6347EC048A4065B7");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__UserAcco__0CF04B18A9B5B783");
